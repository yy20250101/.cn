...
const initialSites = [
  ...
  },
  {
    ...
    "category": "netdisk",
    "icon": "bi-search",
    "faviconUrl": "https://favicon.yandex.net/favicon/pan.baidu.com"
  },
  {
    "name": "DeepSeek",
  ...
  },
  {
    ...
    "category": "tools",
    "icon": "bi-tools",
    "faviconUrl": "https://favicon.yandex.net/favicon/tool.chinaz.com"
  },
  {
    "name": "在线Ping",
  ...
  },
  {
    ...
    "category": "media",
    "icon": "bi-play-circle",
    "faviconUrl": "https://www.yinfans.me/wp-content/themes/Loos2/images/favicon.ico"
  },
  {
    "name": "米兔音乐",
  ...
  },
  {
    ...
    "category": "media",
    "icon": "bi-play-circle",
    "faviconUrl": "https://silidm.com/favicon.ico"
  },
  {
    "name": "菠萝搜搜",
    ...
    "category": "search",
    "icon": "bi-search",
    "faviconUrl": "https://blsoso.com/uploads/image/20250425/5dd50da33c9b2dd6c00817cc47f19365.png"
  },
  {
    "name": "视频素材站",
    "url": "https://coverr.co/",
  ...
  {
    "name": "当贝AI_DeepSeek满血版",
    "url": "https://ai.dangbei.com/chat",
    "category": "ai",
    "icon": "bi-robot",
    "faviconUrl": "https://ai.dangbei.com/logo.svg"
  },
  {
    "name": "国家超算中心",
    ...
    "category": "ai",
    "icon": "bi-robot",
    "faviconUrl": "https://www.scnet.cn/favicon.ico"
  },
  {
    "name": "库房369导航",
    "url": "https://kf369.cn/",
    "category": "common",
    "icon": "bi-link",
    "faviconUrl": "https://kf369.cn/favicon.ico"
  },
  {
    "name": "临时邮箱",
    ...
    "category": "social",
    "icon": "bi-people",
    "faviconUrl": "https://favicon.yandex.net/favicon/temp-mail.org"
  },
  {
    "name": "身份大全随机生成个人资料",
    ...
    "category": "common",
    "icon": "bi-link",
    "faviconUrl": "https://favicon.yandex.net/favicon/shenfendaquan.com"
  }
];
...
function initializeEventListeners() {
  ...
  elements.resetSearchBtn = document.getElementById('reset-search-btn');
...
async function loadAllFavicons() {
  ...
  for (let i = 0; i < sites.length; i += batchSize) {
      ...
      // 添加短暂延迟，避免请求过于频繁 (如果需要，可以保留一个总的延迟在这里，或者移除)
      // await new Promise(resolve => setTimeout(resolve, 300)); 
  }

  // 所有批次处理完毕后，进行一次最终的渲染和保存
  renderSites();
  localStorage.setItem('sites', JSON.stringify(sites.map(site => {
      // 清理临时属性并直接保存最终版本
...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (storedSites === null || JSON.parse(storedSites).length === 0) {
      ...
      sites = [...initialSites]; // 使用initialSites的副本
      localStorage.setItem('sites', JSON.stringify(sites));
